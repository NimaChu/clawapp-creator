...
For a more custom high-polish cover, do a separate art pass with the [$svg-cover-generator](/Users/chunima/.codex/skills/svg-cover-generator/SKILL.md) skill, or another explicit content-driven cover design step, and then replace `assets/thumbnail.png`.
